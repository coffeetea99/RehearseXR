...
public class ScriptReader : MonoBehaviour
{
    ...
    private static readonly ScriptLine[] fullScript = new ScriptLine[]{
        new ScriptLine(0f, "A와 B 손전등을 켜고 방 안을 뒤진다 <color=red>(가운데 조명이 약하게 켜져 있다)</color>\n"),
        new ScriptLine(2f, "A : 찾았어?"),
        new ScriptLine(4.5f, "B : 아니, 아직."),
        new ScriptLine(7.5f, "A : 큰일 났네."),
        new ScriptLine(10.5f, "B : 어떡하지?\n"),
        new ScriptLine(12f, "C가 방 안으로 들어오며 불을 켠다 <color=red>(가운데 조명의 세기를 올린다)</color>\n"),
        ...
        new ScriptLine(50f, "A : <color=red>(왼쪽 조명을 켠다)</color> 여기 있나?"),
        new ScriptLine(58f, "B : <color=red>(오른쪽 조명을 켠다)</color> 난 이쪽 찾아볼게.\n"),
        ...
        new ScriptLine(77.5f, "A : <color=red>(왼쪽 조명을 끈다)</color> 어디 있는 거야 진짜."),
        ...
        new ScriptLine(106f, "<color=red>갑자기 사이렌이 울리며 붉은 조명이 들어온다 (가운데, 오른쪽 조명을 붉은 색으로 바꾼다)</color>\n"),
        ...
        new ScriptLine(134f, "<color=red>서서히 암전 (가운데, 오른쪽 조명의 세기를 꺼질 때까지 서서히 낮춘다)</color>"),
    };
}
